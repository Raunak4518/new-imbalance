...
def download_dataset(dest_path):
    """Download MALARIA_CELL directly from official source (no Kaggle API needed)."""
    ...
    if kaggle_path:
        ...
        if find_file_recursive(dest, REQUIRED_FILE):
            ...
            if success:
                ...
                print("Or click '+ Add Data' and search for: iarunava/cell-images-for-detecting-malaria")
                sys.exit(1)
