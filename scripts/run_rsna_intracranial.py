...
DATASET_NAME   = "RSNA_Intracranial"
DATASET_SLUG   = "rsna-intracranial-hemorrhage-detection"
DATASET_HANDLE = "rsna-intracranial-hemorrhage-detection"
IS_COMPETITION = True
DOWNLOAD_CMD   = """kaggle competitions download -c rsna-intracranial-hemorrhage-detection"""
NUM_CLASSES    = 6
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: rsna-intracranial-hemorrhage-detection")
