...
DATASET_SLUG   = "brats20-dataset-training-validation"
DATASET_HANDLE = "awsaf49/brats20-dataset-training-validation"
IS_COMPETITION = False
DOWNLOAD_CMD   = """kaggle datasets download awsaf49/brats20-dataset-training-validation"""
NUM_CLASSES    = 4
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: awsaf49/brats20-dataset-training-validation")
