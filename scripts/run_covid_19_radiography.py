...
DATASET_NAME   = "COVID-19_Radiography"
DATASET_SLUG   = "covid19-radiography-database"
DATASET_HANDLE = "tawsifurrahman/covid19-radiography-database"
IS_COMPETITION = False
DOWNLOAD_CMD   = """kaggle datasets download tawsifurrahman/covid19-radiography-database"""
NUM_CLASSES    = 4
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: tawsifurrahman/covid19-radiography-database")
