...
DATASET_HANDLE = "aptos2019-blindness-detection"
IS_COMPETITION = True
DOWNLOAD_CMD   = """kaggle competitions download -c aptos2019-blindness-detection"""
NUM_CLASSES    = 5
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: aptos2019-blindness-detection")
