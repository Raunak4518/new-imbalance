...
DATASET_HANDLE = "rsna-pneumonia-detection-challenge"
IS_COMPETITION = True
DOWNLOAD_CMD   = """kaggle competitions download -c rsna-pneumonia-detection-challenge"""
NUM_CLASSES    = 2
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: rsna-pneumonia-detection-challenge")
