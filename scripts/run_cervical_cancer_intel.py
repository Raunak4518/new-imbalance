...
DATASET_NAME   = "Cervical_Cancer_Intel"
DATASET_SLUG   = "intel-mobileodt-cervical-cancer-screening"
DATASET_HANDLE = "intel-mobileodt-cervical-cancer-screening"
IS_COMPETITION = True
DOWNLOAD_CMD   = """kaggle competitions download -c intel-mobileodt-cervical-cancer-screening"""
NUM_CLASSES    = 3
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: intel-mobileodt-cervical-cancer-screening")
