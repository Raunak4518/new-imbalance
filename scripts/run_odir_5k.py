...
DATASET_SLUG   = "ocular-disease-recognition-odir5k"
DATASET_HANDLE = "andrewmvd/ocular-disease-recognition-odir5k"
IS_COMPETITION = False
DOWNLOAD_CMD   = """kaggle datasets download andrewmvd/ocular-disease-recognition-odir5k"""
NUM_CLASSES    = 8
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: andrewmvd/ocular-disease-recognition-odir5k")
