...
DOWNLOAD_CMD   = """Manual Download Required"""
NUM_CLASSES    = 4
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("Source: https://ieee-dataport.org/open-access/indian-diabetic-retinopathy-image-dataset-idrid")
        print("Note:   Download from IEEE DataPort (free, requires IEEE login)")
