...
DATASET_NAME   = "PANDA_Challenge"
DATASET_SLUG   = "prostate-cancer-grade-assessment"
DATASET_HANDLE = "prostate-cancer-grade-assessment"
IS_COMPETITION = True
DOWNLOAD_CMD   = """kaggle competitions download -c prostate-cancer-grade-assessment"""
NUM_CLASSES    = 6
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: prostate-cancer-grade-assessment")
