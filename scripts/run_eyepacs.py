...
DATASET_HANDLE = "diabetic-retinopathy-detection"
IS_COMPETITION = True
DOWNLOAD_CMD   = """kaggle competitions download -c diabetic-retinopathy-detection"""
NUM_CLASSES    = 5
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: diabetic-retinopathy-detection")
