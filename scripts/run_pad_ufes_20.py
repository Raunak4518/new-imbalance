...
DOWNLOAD_CMD   = """wget -O pad_ufes.zip https://data.mendeley.com/public-files/datasets/zr7vgbcyr2/files/..."""
NUM_CLASSES    = 7
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("Source: https://data.mendeley.com/datasets/zr7vgbcyr2/1")
        print("Note:   Download from Mendeley Data (free, no auth required, but redirect-based)")
