...
DATASET_NAME   = "PCam"
DATASET_SLUG   = "histopathologic-cancer-detection"
DATASET_HANDLE = "histopathologic-cancer-detection"
IS_COMPETITION = True
DOWNLOAD_CMD   = """kaggle competitions download -c histopathologic-cancer-detection"""
NUM_CLASSES    = 2
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: histopathologic-cancer-detection")
