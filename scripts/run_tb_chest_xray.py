...
DATASET_SLUG   = "tuberculosis-tb-chest-xray-dataset"
DATASET_HANDLE = "tawsifurrahman/tuberculosis-tb-chest-xray-dataset"
IS_COMPETITION = False
DOWNLOAD_CMD   = """kaggle datasets download tawsifurrahman/tuberculosis-tb-chest-xray-dataset"""
NUM_CLASSES    = 2
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: tawsifurrahman/tuberculosis-tb-chest-xray-dataset")
