...
DOWNLOAD_CMD   = """PhysioNet Credential Required"""
NUM_CLASSES    = 14
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("Source: https://physionet.org/content/mimic-cxr-jpg/2.0.0/")
        print("Note:   Requires PhysioNet credentialed access")
