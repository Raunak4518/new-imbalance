...
DATASET_NAME   = "Blood_Cell_Detection"
DATASET_SLUG   = "blood-cells"
DATASET_HANDLE = "paultimothymooney/blood-cells"
IS_COMPETITION = False
DOWNLOAD_CMD   = """kaggle datasets download paultimothymooney/blood-cells"""
NUM_CLASSES    = 4
SEED           = 42
IMG_SIZE       = 224
...
if not DATASET_PATH:
    ...
    if kaggle_path:
        ...
        print("2. Search for: paultimothymooney/blood-cells")
