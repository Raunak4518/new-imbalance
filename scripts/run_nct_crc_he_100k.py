...
DATASET_SLUG   = "colorectal-histology-mnist"
DATASET_HANDLE = "kmader/colorectal-histology-mnist"
IS_COMPETITION = False
DOWNLOAD_CMD   = """kaggle datasets download kmader/colorectal-histology-mnist"""
NUM_CLASSES    = 9
SEED           = 42
IMG_SIZE       = 224
...
def download_dataset(dest_path):
    """Download NCT_CRC_HE_100K directly from official source (no Kaggle API needed)."""
    ...
    if kaggle_path:
        ...
        if find_file_recursive(dest, REQUIRED_FILE):
            ...
            if success:
                ...
                print("Or click '+ Add Data' and search for: kmader/colorectal-histology-mnist")
                sys.exit(1)
